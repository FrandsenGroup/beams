...
MUD_setHistData( int fd, int num, void* pData )
{
  ...
  {
    case 0:
      pMUD_histDat->pData = (char*)zalloc( 4*pMUD_histHdr->nBins + 32 );
      break;
    default:
      pMUD_histDat->pData = (char*)zalloc( 
...
MUD_setIndVarData( int fd, int num, void* pData )
{
  ...
  {
    case 0:
      pMUD_array->pData = (char*)zalloc( 4*pMUD_array->num + 32 );
      break;
    default:
      pMUD_array->pData = (char*)zalloc( pMUD_array->num*pMUD_array->elemSize );
      break;
  }
