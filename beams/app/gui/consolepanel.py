...
class MainConsolePanel(QtWidgets.QDockWidget):
    class Tree(QtWidgets.QTreeWidget):
        ...
        def _launch_menu(self, point):
            ...
            new_check_state = qt_constants.Checked if item.checkState(0) == qt_constants.Unchecked else qt_constants.Unchecked
    ...
    def __init__(self):
        ...
        self.tree_view.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
