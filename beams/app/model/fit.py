...
INTERNAL_COSINE = f"a*(f*cos(2*{PI}*{NU}*t + {PI}*{PHI}/180)*exp(-{LAMBDA}T*t) + (1 - f)*exp(-{LAMBDA}L*t))"
BESSEL = f"a*sin(2*{PI}*{NU}*t + {PI}*{PHI}/180)/(2*{PI}*{NU}*t + {PI}*{PHI}/180)"
INTERNAL_BESSEL = f"a*(f*sin(2*{PI}*{NU}*t + {PI}*{PHI}/180)/(2*{PI}*{NU}*t + {PI}*{PHI}/180)*exp(-{LAMBDA}T*t) + (1-f)*exp(-{LAMBDA}L*t)"
...
DEFAULT_VALUES = {
    ...
    "Internal Cosine": {'a': 0.25, 'f': 0.667, NU: 1, PHI: 0, f'{LAMBDA}T': 1, f'{LAMBDA}L': 0.1},
    "Bessel": {'a': 0.25, NU: 1, PHI: 0},
    "Internal Bessel": {'a': 0.25, 'f': 0.667, NU: 1, PHI: 0, f'{LAMBDA}T': 1, f'{LAMBDA}L': 0.1}
}
