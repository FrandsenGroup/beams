...
class BEAMS(QtWidgets.QApplication):
    ...
    def __init__(self):
        ...
        if darkdetect.isDark():
            self.setStyleSheet(mainwindow.StyleFile(resources.LIGHT_STYLE_SHEET, resources.DARK_STYLE_VARIABLES).style)
        else:
            self.setStyleSheet(mainwindow.StyleFile(resources.LIGHT_STYLE_SHEET, resources.LIGHT_STYLE_VARIABLES).style)
