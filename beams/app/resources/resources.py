...
LATO_BLACK_FONT = str(Path('beams/app/resources/fonts/fonts-Black.ttf'))
LATO_BLACK_ITALIC_FONT = str(Path('beams/app/resources/fonts/fonts-BlackItalic.ttf'))
LATO_BOLD_FONT = str(Path('beams/app/resources/fonts/fonts-Bold.ttf'))
LATO_BOLD_ITALIC_FONT = str(Path('beams/app/resources/fonts/fonts-BoldItalic.ttf'))
LATO_ITALIC_FONT = str(Path('beams/app/resources/fonts/fonts-Italic.ttf'))
LATO_LIGHT_FONT = str(Path('beams/app/resources/fonts/fonts-Light.ttf'))
LATO_LIGHT_ITALIC_FONT = str(Path('beams/app/resources/fonts/fonts-LightItalic.ttf'))
LATO_REGULAR_FONT = str(Path('beams/app/resources/fonts/fonts-Regular.ttf'))
LATO_THIN_FONT = str(Path('beams/app/resources/fonts/fonts-Thin.ttf'))
LATO_THIN_ITALIC_FONT = str(Path('beams/app/resources/fonts/fonts-ThinItalic.ttf'))

PSI_LINUX_CONVERSION = str(Path('/beams/app/resources/binaries/PSI_LINUX'))
PSI_WINDOWS_CONVERSION = str(Path('/beams/app/resources/binaries/PSI_WINDOWS.exe'))
TRIUMF_LINUX_CONVERSION = str(Path('/beams/app/resources/binaries/TRIUMF_LINUX'))
TRIUMF_MAC_CONVERSION = str(Path('/beams/app/resources/binaries/TRIUMF_MAC'))
TRIUMF_WINDOWS_CONVERSION = str(Path('/beams/app/resources/binaries/TRIUMF_WINDOWS.exe'))
